...
public class ModVillagers {
    ...
    public static void fillTradeData() {
        ...
        BOOTS.enchant(Enchantments.FEATHER_FALLING,4);
        ...
        FISHING_ROD.enchant(Enchantments.LURE,3);
        FISHING_ROD.enchant(Enchantments.LUCK_OF_THE_SEA,3);
        ...
        PICKAXE.enchant(Enchantments.EFFICIENCY,5);
        PICKAXE.enchant(Enchantments.FORTUNE,3);
