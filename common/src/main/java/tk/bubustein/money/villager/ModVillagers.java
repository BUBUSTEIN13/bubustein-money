    ...
    public static void fillTradeData() {
        ...
        VillagerTrades.ItemListing[][] exchangerTrades = {
                // Level 1
                {
                        ...
                        new SimpleTrade(new ItemCost(ModItems.Euro5.get(), 1), Optional.empty(), new ItemStack(ModItems.Leva5.get(), 2), 10, 2, 0.1f),
                        new SimpleTrade(new ItemCost(ModItems.Zloty10.get(), 1), Optional.empty(), new ItemStack(ModItems.Euro2.get(), 1), 10, 2, 0.1f),
                        new SimpleTrade(new ItemCost(ModItems.Euro5.get(), 1), Optional.empty(), new ItemStack(ModItems.Zloty20.get(), 1), 10, 2, 0.1f),
                        new SimpleTrade(new ItemCost(ModItems.INr100.get(), 1), Optional.empty(), new ItemStack(ModItems.Dollar1.get(), 1), 10, 2, 0.1f),
                        new SimpleTrade(new ItemCost(ModItems.Dollar5.get(), 1), Optional.empty(), new ItemStack(ModItems.INr100.get(), 4), 10, 2, 0.1f),
                        new SimpleTrade(new ItemCost(ModItems.Euro1.get(), 1), Optional.empty(), new ItemStack(ModItems.TRl5.get(), 7), 10, 2, 0.1f),
                ...
                // Level 2
                {
                        new SimpleTrade(new ItemCost(ModItems.DollarC10.get(), 1), Optional.of(new ItemCost(ModItems.Loonie.get(), 4)), new ItemStack(ModItems.Dollar10.get(), 1), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.DollarA10.get(), 1), Optional.empty(), new ItemStack(ModItems.Pound5.get(), 1), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.CZkr100.get(), 1), Optional.empty(), new ItemStack(ModItems.Euro2.get(), 2), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Euro5.get(), 1), Optional.empty(), new ItemStack(ModItems.CZkr100.get(), 1), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.NOkr50.get(), 1), Optional.empty(), new ItemStack(ModItems.Euro2.get(), 2), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Euro5.get(), 1), Optional.empty(), new ItemStack(ModItems.NOkr50.get(), 1), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.RSD200.get(), 1), Optional.empty(), new ItemStack(ModItems.Euro1.get(), 1), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Euro5.get(), 1), Optional.empty(), new ItemStack(ModItems.RSD500.get(), 1), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.ISkr1000.get(), 1), Optional.empty(), new ItemStack(ModItems.Euro5.get(), 1), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Euro10.get(), 1), Optional.empty(), new ItemStack(ModItems.ISkr500.get(), 3), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.NZD2.get(), 1), Optional.empty(), new ItemStack(ModItems.Dollar1.get(), 1), 7, 5, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Dollar10.get(), 1), Optional.empty(), new ItemStack(ModItems.NZD5.get(), 3), 7, 5, 0.2f)
                },
                // Level 3
                {
                        new SimpleTrade(new ItemCost(ModItems.Yen50.get(), 3), Optional.empty(), new ItemStack(ModItems.Dollar1.get(), 1), 5, 7, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Euro10.get(), 1), Optional.empty(), new ItemStack(ModItems.Lei50.get(), 1), 5, 7, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.DKkr50.get(), 1), Optional.empty(), new ItemStack(ModItems.Euro2.get(), 3), 5, 7, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Euro5.get(), 1), Optional.empty(), new ItemStack(ModItems.DKkr10.get(), 4), 5, 7, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Ft500.get(), 1), Optional.empty(), new ItemStack(ModItems.Euro1.get(), 1), 5, 7, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Euro5.get(), 1), Optional.empty(), new ItemStack(ModItems.Ft500.get(), 3), 5, 7, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.SEkr20.get(), 1), Optional.empty(), new ItemStack(ModItems.Euro1.get(), 1), 5, 7, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Euro5.get(), 1), Optional.empty(), new ItemStack(ModItems.SEkr50.get(), 1), 5, 7, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.CNYuan10.get(), 1), Optional.empty(), new ItemStack(ModItems.Dollar1.get(), 1), 5, 7, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Dollar5.get(), 1), Optional.empty(), new ItemStack(ModItems.CNYuan5.get(), 7), 5, 7, 0.2f)
                },
                // Level 4
                {
                        new SimpleTrade(new ItemCost(ModItems.Lei10.get(), 1), Optional.empty(), new ItemStack(ModItems.LeiMD50.get(), 1), 5, 10, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Dollar5.get(), 1), Optional.empty(), new ItemStack(ModItems.Yen50.get(), 15), 5, 10, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Won10000.get(), 2), Optional.empty(), new ItemStack(ModItems.Dollar5.get(), 3), 5, 10, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Dollar10.get(), 1), Optional.empty(), new ItemStack(ModItems.Won10000.get(), 1), 5, 10, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.BRReal10.get(), 1), Optional.empty(), new ItemStack(ModItems.Dollar1.get(), 2), 5, 10, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Dollar5.get(), 1), Optional.empty(), new ItemStack(ModItems.BRReal20.get(), 1), 5, 10, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.MXPeso100.get(), 1), Optional.empty(), new ItemStack(ModItems.Dollar5.get(), 1), 5, 10, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Dollar1.get(), 2), Optional.empty(), new ItemStack(ModItems.MXPeso10.get(), 3), 5, 10, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.ZARand50.get(), 1), Optional.empty(), new ItemStack(ModItems.Pound2.get(), 1), 5, 10, 0.2f),
                        new SimpleTrade(new ItemCost(ModItems.Pound5.get(), 1), Optional.empty(), new ItemStack(ModItems.ZARand100.get(), 1), 5, 10, 0.2f)
                },
                // Level 5
                {
