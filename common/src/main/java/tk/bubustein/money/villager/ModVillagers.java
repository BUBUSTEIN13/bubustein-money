    ...
    public static void fillTradeData() {
        VillagerTrades.ItemListing[][] bankerTrades = {
                // Level 1
                {
                        ...
                        new SimpleTrade(new ItemCost(ModItems.Pound5.get(), 10), Optional.empty(), new ItemStack(Items.EMERALD, 1), 10, 3, 0.1f),
                ...
                // Level 2
                {
                        ...
                        new SimpleTrade(new ItemCost(Items.EMERALD, 10), Optional.of(new ItemCost(Items.PAPER, 1)), new ItemStack(ModItems.Dollar100.get(), 1), 5, 6, 0.2f)
                },
                // Level 3
                {
                        new SimpleTrade(new ItemCost(Items.EMERALD, 52), Optional.of(new ItemCost(Items.PAPER, 1)), new ItemStack(ModItems.Euro500.get(), 1), 4, 10, 0.2f)
                },
                // Level 4
                {
                        new SimpleTrade(new ItemCost(ModItems.L5.get(), 1), Optional.of(new ItemCost(Items.GOLD_INGOT, 3)), new ItemStack(Items.EMERALD, 5), 3, 20, 0.9f),
                },
                // Level 5
                {
