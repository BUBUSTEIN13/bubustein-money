...
public class BankMachineRecipeShapeless implements BankMachineRecipe {
    ...
    public static class Serializer implements RecipeSerializer<BankMachineRecipeShapeless> {
        ...
        public @NotNull BankMachineRecipeShapeless fromJson(ResourceLocation resourceLocation, JsonObject jsonObject) {
        ...
        public @NotNull BankMachineRecipeShapeless fromNetwork(ResourceLocation resourceLocation, FriendlyByteBuf friendlyByteBuf) {
