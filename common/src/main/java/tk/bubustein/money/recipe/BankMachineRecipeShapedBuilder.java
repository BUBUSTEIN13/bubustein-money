...
public class BankMachineRecipeShapedBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation resourceLocation) {
        ...
        consumer.accept(new BankMachineRecipeShapedBuilder.Result(resourceLocation, this.result, this.count, this.group == null ? "" : this.group, this.rows, this.key, this.advancement, resourceLocation.withPrefix("recipes/"), this.showNotification));
    }
    ...
    private static class Result implements FinishedRecipe {
        ...
        public void serializeRecipeData(JsonObject jsonObject) {
            ...
            for (Map.Entry<Character, Ingredient> characterIngredientEntry : this.key.entrySet()) {
                jsonObject2.add(String.valueOf(characterIngredientEntry.getKey()), characterIngredientEntry.getValue().toJson());
            }
