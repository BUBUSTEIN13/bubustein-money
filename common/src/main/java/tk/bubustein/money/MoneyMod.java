...
public class MoneyMod {
    ...
    public static final ResourceKey<LootTable> BANKER_HOUSE_CHEST = ResourceKey.create(Registries.LOOT_TABLE, new ResourceLocation(MoneyMod.MOD_ID, "chests/banker_house_chest"));
    public static final ResourceKey<LootTable> MANSION_DOUBLE_CHEST = ResourceKey.create(Registries.LOOT_TABLE, new ResourceLocation(MoneyMod.MOD_ID, "chests/mansion_double_chest"));
    public static final ResourceKey<LootTable> MANSION_CHEST = ResourceKey.create(Registries.LOOT_TABLE, new ResourceLocation(MoneyMod.MOD_ID, "chests/mansion_chest"));
