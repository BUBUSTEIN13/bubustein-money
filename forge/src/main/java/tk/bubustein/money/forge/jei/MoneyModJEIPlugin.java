...
public class MoneyModJEIPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<BankMachineRecipe> recipes = new ArrayList<>(recipeManager.getAllRecipesFor(ModRecipes.BANK_MACHINE_RECIPE));
        LOGGER.info( "[" + MoneyMod.MOD_ID +"] Loaded {} Bank Machine recipes", recipes.size());
        registration.addRecipes(recipes, BankMachineCategory.UID);
    }
}